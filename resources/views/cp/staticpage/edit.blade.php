			...
			<div class="col-lg-12">
				<div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
						<h3 class="card-title" style="font-weight:bold;">{{__('static.info')}}</h3>
                        ...
                        <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										<label>{{__("static.title")}}</label>
										<input type="text" id="title" name="title" value="{{$obj?$obj->title:''}}" class="form-control form-control-solid" placeholder="{{__("static.enter").' '.__("static.title")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                <div class="col-md-12">
									<div class="form-group">
										<label>{{__("static.desccode")}}</label>
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										<label style="clear: both; display: block;">{{__("static.file")}}</label>
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										<label style="clear: both; display: block; margin-bottom: 20px;">{{__("static.mainfile")}}</label>
                                        <img style="" src="{{ route("admin.staticpage.getimg") }}/{{$obj->id}}&&date=<%date%>">
                                    </div>
								</div>
                                <div class="col-md-12">
									<div class="form-group">
