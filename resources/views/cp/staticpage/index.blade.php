							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                    ...
                                    <div class="row p-0">
										...
										<a href="#server-side"></a>الصفحات الثابتة</h1>
                                        <div class="d-flex justify-content-end" style="width: 50%;" data-kt-docs-table-toolbar="base">
											<a class="btn btn-primary" target="_blank" href="{{ route('admin.staticpage.add') }}" title="إضافة جديد">
											    ...
											    <table id="kt-datatable" class="table align-middle table-row-dashed fs-6 gy-5">
												    <thead>
													    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
														    ...
														    <th style="padding-right: 10px;" width="50%">إسم الصفحة</th>
    ...
    return {
        ...
        init: function () {
            e = $("#kt-datatable").DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.staticpage.index.ajax') }}"
                    ...
                    render: function (e, t, n) {
                        ...
                        var x = '\
                                <div class="d-flex justify-content-end flex-shrink-0">\
									<a target="_blank" href="{{ route("admin.staticpage.edit") }}/'+n.id+'" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" target="_blank" title="تعديل بيانات مقال '+n.title+'">\
