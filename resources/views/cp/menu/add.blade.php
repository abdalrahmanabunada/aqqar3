                        ...
                        <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="title" name="title" value="" class="form-control form-control-solid" placeholder="{{__("menu.enter").' '.__("menu.title")}}" autocomplete="off">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="link" name="link" value="" class="form-control form-control-solid" placeholder="{{__("menu.enter").' '.__("menu.link")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="order" name="order" value="" class="form-control form-control-solid" placeholder="{{__("menu.enter").' '.__("menu.order")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <select id="typeid" name="typeid" class="form-control">
                                            <option value="">إختر من القائمة</option>
                                            <option value="1"> قائمة الرئيسية</option>
                                            <option value="2"> قائمة footer</option>
                                        </select>
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                ...
                                <div class="col-md-2" style="padding-top:40px;">
									<div class="form-group">
										...
										<div class="form-check form-check-sm form-check-custom form-check-solid me-3">
											<input class="form-check-input" name="external" type="checkbox" data-kt-check="true" data-kt-check-target="#kt-datatable .form-check-input" value="1" />
                                            <span style="font-weight: bold; margin-right: 10px;">
                                            {{__("menu.external")}}
                                            </span>
										</div>
                                ...
                                <div class="col-md-2" style="padding-top:40px;">
									<div class="form-group">
										...
										<div class="form-check form-check-sm form-check-custom form-check-solid me-3">
											<input class="form-check-input" name="newtap" type="checkbox" data-kt-check="true" data-kt-check-target="#kt-datatable .form-check-input" value="1" />
                                            <span style="font-weight: bold; margin-right: 10px;">
                                            {{__("menu.newtap")}}
                                            </span>
										</div>
