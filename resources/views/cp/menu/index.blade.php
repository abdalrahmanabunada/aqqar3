							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                    ...
                                    <div class="row p-0">
										...
										<a href="#server-side"></a>قوائم النظام</h1>
                                        <div class="d-flex justify-content-end" style="width: 50%;" data-kt-docs-table-toolbar="base">
											<a class="btn btn-primary" target="_blank" href="{{ route('admin.menu.add') }}" title="إضافة جديد">
                                     ...
                                     <div class="row" style="margin-top:20px;">
                                        ...
                                        <div class="col-md-3">
									        <div class="form-group">
										        <label style="margin-bottom: 10px; color: #181c32; font-weight: bold;">{{__("menu.typeid")}}</label>
                                                <select id="typeid" name="typeid" class="form-control" style="margin-top: -5px;">
    ...
    return {
        ...
        init: function () {
            e = $("#kt-datatable").DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.menu.index.ajax') }}"
                    ...
                    render: function (e, t, n) {
                        ...
                        var x = '\
                                <div class="d-flex justify-content-end flex-shrink-0">\
									<a target="_blank" href="{{ route("admin.menu.edit") }}/'+n.id+'" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" target="_blank" title="تعديل بيانات مقال '+n.title+'">\
